...
#Script Edited By Zeeshan Altaf

#Utf-8 python 

try:

	import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass	from requests.exceptions import ConnectionError
...
\033[1;92mAuthor \033[1;93m: Khanbab
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#THANKX SHANI BRO
